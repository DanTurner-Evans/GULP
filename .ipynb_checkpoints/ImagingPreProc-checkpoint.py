...
def motionCorrectSlicedStack(div_stack_MIP, num_ref_img = 100, upsample_factor = 20, sigma = 2):
    ...
    if div_stack_MIP.shape[2] > 1:
        ...
        for vol in range(divStackMIP.shape[1]):
            for frame in range(0,shift_dat[v].shape[1]):
        ...
        corrected_stacks = [corrected_stack_1, corrected_stack_2]
    else:
...
def getPolyROIs(viewer, stack):
    ...
    for i,r in enumerate(rois):
        ...
        allMasks = allMasks.append(roiInfo)
